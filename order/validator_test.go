...
func getRequest() model.CreateOrderRequest {
...
func TestShouldReturnErrorWhenCustomerIdIsEmpty(t *testing.T) {
	...
	assertion.ErrorContains(err, "customer id is missing in the request for order at index 0")
}
...
func TestShouldReturnErrorWhenOrderItemIdIsEmpty(t *testing.T) {
	...
	assertion.ErrorContains(err, "item at index 1 does not have item id for order at index 0")
}
...
func TestShouldReturnErrorWhenOrderItemCostIsInvalid(t *testing.T) {
	...
	assertion.ErrorContains(err, "item at index 1 has negative cost value for order at index 0")
}
